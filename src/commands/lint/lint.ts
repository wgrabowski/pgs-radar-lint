...
function getDependenciesIncludedInRadar(dependencies: string[], packagesOnHold: Map<string, RadarPackageEntry>) {
...
async function lintPackages(directoryPath: string, config: PGSRadarLinterConfig): Promise<Record<PGSRadarStatus, RadarPackageEntry[]>> {
	...
	return {
		[PGSRadarStatus.Adopt]: getDependenciesIncludedInRadar(dependencies, getPackagesByStatus(radarsEntries, PGSRadarStatus.Adopt)),
		[PGSRadarStatus.Assess]: getDependenciesIncludedInRadar(dependencies, getPackagesByStatus(radarsEntries, PGSRadarStatus.Assess)),
		[PGSRadarStatus.Trial]: getDependenciesIncludedInRadar(dependencies, getPackagesByStatus(radarsEntries, PGSRadarStatus.Trial)),
		[PGSRadarStatus.Hold]: getDependenciesIncludedInRadar(dependencies, getPackagesByStatus(radarsEntries, PGSRadarStatus.Hold)),
	};
}
